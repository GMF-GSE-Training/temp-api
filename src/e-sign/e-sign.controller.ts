import { Body, Controller, Delete, Get, HttpCode, HttpException, HttpStatus, Param, ParseIntPipe, ParseUUIDPipe, Patch, Post, Query, Req, UploadedFiles, UseGuards, UseInterceptors } from "@nestjs/common";
import { FileFieldsInterceptor } from "@nestjs/platform-express";
import { Roles } from "src/shared/decorator/role.decorator";
import { AuthGuard } from "src/shared/guard/auth.guard";
import { RoleGuard } from "src/shared/guard/role.guard";
import { CreateESign, ESignResponse, UpdateESign } from "src/model/e-sign.model";
...
export class ESignController {
    ...
    async create(
        ...
        try {
            eSign = {
                ...request,
                eSignFileName: request.eSignFileName ? request.eSignFileName : 'e-sign.png',
    ...
    @Roles('super admin')
    @UseGuards(AuthGuard, RoleGuard)
    async getESignFile(@Param('eSignId', ParseUUIDPipe) eSignId: string): Promise<WebResponse<string>> {
