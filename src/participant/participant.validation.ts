...
export class ParticipantValidation {
    static readonly CREATE: ZodType = z.object({
        ...
        name: z.string().min(1).max(50).regex(/^[a-zA-Z\s]+$/, { message: "Nama hanay boleh berisi huruf" }),
    ...
    static readonly UPDATE: ZodType = z.object({
        ...
        name: z.string().min(1).max(50).regex(/^[a-zA-Z\s]+$/, { message: "Nama hanay boleh berisi huruf" }).optional(),
