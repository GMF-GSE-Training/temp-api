import { Body, Controller, HttpException, Param, ParseUUIDPipe, Post, StreamableFile, UseGuards } from "@nestjs/common";
...
export class CertificateController {
    ...
    async create(
        ...
        try {
            const result = await this.certificateService.createCertificate(cotId, participantId, request);
