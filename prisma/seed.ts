...
async function seedDatabase(prismaService: PrismaClient) {
    ...
    const suratBebasNarkoba = fs.readFileSync(path.join(__dirname, '..', 'assets', 'image', 'surat_bebas_narkoba.png'));
    ...
    const dataDummy = [
        ...
        { name: "Zara Maharani", birthPlace: "Banjarmasin", birthDate: "1992-04-16" },
        ...
        { name: "Hana Rahmawati", birthPlace: "Balikpapan", birthDate: "1997-01-01" },
        ...
        { name: "Linda Sari", birthPlace: "Bandar Lampung", birthDate: "1998-07-13" },
        ...
        { name: "Panca Ramadhan", birthPlace: "Samarinda", birthDate: "1995-08-08" },
        ...
        { name: "Windi Pratiwi", birthPlace: "Tanjungpinang", birthDate: "2002-11-30" },
        { name: "Xavier Raka", birthPlace: "Pematangsiantar", birthDate: "1993-04-01" },
